...
const Home = () => {
  ...
  const categories = [
    { id: 1, name: "Bespoke Suiting", image: "https://images.unsplash.com/photo-1593032465175-481ac7f401a0?auto=format&fit=crop&q=80&w=800", count: "500+ Selections" },
    { id: 2, name: "Premium Shirting", image: "https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?auto=format&fit=crop&q=80&w=800", count: "300+ Weaves" },
    { id: 3, name: "Luxury Linen", image: "https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?auto=format&fit=crop&q=80&w=800", count: "Fine Threadcount" },
    { id: 4, name: "Men's Essentials", image: "https://images.unsplash.com/photo-1617137968427-85924c800a22?auto=format&fit=crop&q=80&w=800", count: "Curated Brands" },
  ];
  ...
  return (
    <div className="overflow-hidden">
      ...
      {/* Brand Heritage Bar */}
      <section className="py-10 glass-dark border-y border-white/5 relative z-20">
      ...
      {/* Curated Collections Section - 3-Column Grid */}
      <section className="section-padding bg-cream relative overflow-hidden">
         <div className="container">
            {/* Section Header */}
            <div className="flex flex-col lg:flex-row items-baseline justify-between mb-20 border-b border-navy/5 pb-12">
               <motion.div
               ...
               >
                  <span className="text-[10px] font-bold tracking-[0.5em] uppercase text-gold mb-4 block">Hand-Picked Selections</span>
                  <h2 className="text-4xl lg:text-6xl font-bold font-heading text-navy leading-tight">Curated <span className="italic font-light">Collections.</span></h2>
               </motion.div>
               <motion.div
                 initial={{ opacity: 0 }}
                 ...
                 className="max-w-sm mt-8 lg:mt-0"
               >
                  <p className="text-navy/50 text-base font-light italic leading-relaxed">
                    "Every thread tells a story of heritage — curated to provide the definitive foundations for your sartorial vision."
                  </p>
               </motion.div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10">
               {[
                 ...
                 },
                 {
                   ...
                   desc: "Breathable, high-density weaves sourced from European flax, designed for the modern gentleman's wardrobe.",
                 ...
                 },
                 {
                   ...
                   desc: "Our private reserve of poly-wool blends and superfine worsted fabrics — the hallmark of Durga Ambica for 25 years.",
                 ...
                 >
                   {/* Image */}
                   <div className="relative overflow-hidden aspect-[3/4] bg-navy mb-8">
                     <img
                       src={collection.image}
                       alt={collection.title}
                       className="w-full h-full object-cover grayscale-[0.4] group-hover:grayscale-0 group-hover:scale-105 transition-all duration-[2000ms]"
                     />
                     <div className="absolute inset-0 bg-navy/20 group-hover:bg-transparent transition-colors duration-700"></div>
                     {/* Tag */}
                     <div className="absolute top-6 left-6 bg-white/90 backdrop-blur-sm px-4 py-1.5 text-[9px] font-bold uppercase tracking-[0.35em] text-navy border-l-2 border-gold opacity-0 group-hover:opacity-100 transition-all duration-500 -translate-x-2 group-hover:translate-x-0">
                       {collection.tag}
                     </div>
                   </div>
                   ...
                   <div className="space-y-4 flex-1 flex flex-col">
                     <span className="text-[9px] font-bold text-gold uppercase tracking-[0.5em]">{collection.subtitle}</span>
                     <h3 className="text-2xl font-bold font-heading text-navy leading-tight group-hover:text-gold/90 transition-colors duration-500">{collection.title}</h3>
                     <p className="text-navy/55 text-sm font-light leading-relaxed flex-1">{collection.desc}</p>
                     <div className="pt-2">
                       <Link href="/products" className="inline-flex items-center space-x-3 text-[10px] font-bold uppercase tracking-[0.3em] text-navy hover:text-gold transition-colors duration-300 group/link">
                         <span>Discover Collection</span>
                         <span className="w-6 h-px bg-navy group-hover/link:w-10 group-hover/link:bg-gold transition-all duration-500"></span>
                       </Link>
                     </div>
                   </div>
                 </motion.div>
      ...
      {/* Fabric Archetypes - 4-Column Grid */}
      <section className="py-16 bg-white">
         <div className="container">
            <div className="text-center mb-10">
               <span className="text-[10px] font-bold tracking-[0.5em] uppercase text-gold mb-4 block">Full Spectrum</span>
               <h2 className="text-3xl lg:text-5xl font-bold font-heading text-navy">Fabric <span className="italic font-light">Archetypes.</span></h2>
            </div>
            ...
            {categories.map((cat, index) => (
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 text-white z-20">
                  <span className="text-[9px] font-bold tracking-[0.4em] uppercase text-gold mb-2 block">{cat.count}</span>
                  <h3 className="text-lg font-bold font-heading text-white drop-shadow-lg">{cat.name}</h3>
                </div>
                
                <div className="absolute inset-0 border border-white/0 group-hover:border-white/20 transition-all duration-700 m-4 pointer-events-none"></div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-14 bg-navy text-white relative overflow-hidden text-center">
        ...
        <div className="container relative z-10">
          ...
          >
            <span className="text-[10px] font-bold tracking-[0.5em] uppercase text-gold mb-4 block">The Atelier Standard</span>
            <h2 className="text-3xl lg:text-5xl font-bold font-heading mb-10">Reliability is our <span className="italic font-light">Greatest Luxury.</span></h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
              {features.map((feature, i) => (
                <div key={i} className="group p-10 border border-white/5 hover:border-gold/20 transition-all duration-700 glass-dark">
                  <div className="w-12 h-12 flex items-center justify-center mb-6 bg-gold/5 border border-gold/10 group-hover:bg-gold group-hover:text-navy transition-all duration-700">
                    {feature.icon}
                  </div>
                  <h4 className="text-base font-bold font-heading text-gold mb-4 uppercase tracking-wider">{feature.title}</h4>
